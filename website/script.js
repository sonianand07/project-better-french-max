        ...
        try {
            ...
            if (data.articles) {
                ...
                articles = articles.map(article => ({
                    ...
                    original_article_title: article.original_article_title || article.title,
                    simplified_english_title: article.simplified_english_title || article.english_title || article.title,
                    simplified_french_title: article.simplified_french_title || article.title,
                    english_summary: article.english_summary || article.summary,
                    french_summary: article.french_summary || article.summary,
                    original_article_link: article.original_article_link || article.link,
                    source_name: article.source_name,
                    published_date: article.published_date || article.published || article.added_at,
                    ...
                    explanations: article.explanations || article.contextual_title_explanations || {},
                    contextual_title_explanations: article.contextual_title_explanations || article.explanations || {},
