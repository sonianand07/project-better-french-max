...
class BetterFrenchApp {
    ...
    async loadLatestData() {
        try {
            ...
            console.log('Number of articles:', data.processed_articles?.length || 0);
            
            this.articles = data.processed_articles || [];
    ...
    async getLatestProcessedFile() {
        // For demo purposes, we'll use the file mentioned in the user's message
        // In a real implementation, this would scan the directory for the latest file
        const fileName = '../04_Data_Output/Processed_AI/ai_processed_curated_news_data_20250531_095437_20250531_150551.json';
        ...
        try {
            ...
            console.warn(`File ${fileName} not found, falling back to default`);
        }
        
        // Fallback to the known file
        return '../04_Data_Output/Processed_AI/ai_processed_curated_news_data_20250531_095437_20250531_150551.json';
    }
